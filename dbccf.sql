...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2017 at 09:03 AM
...
CREATE TABLE `discipleshipgroupmembers_tbl` (
  ...
  `dateJoinedAsDgroupMember` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
ALTER TABLE `discipleshipgroup_tbl`
  ...
  ADD KEY `endorsementID_idx` (`dgendorsementID`),
  ADD KEY `dgleader_idx` (`dgleader`);
...
ALTER TABLE `endorsement_tbl`
  ...
  ADD KEY `endorsedMemberID_idx` (`memberID`);
...
--
ALTER TABLE `discipleshipgroupmembers_tbl`
  MODIFY `dgroupmemberID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `discipleshipgroup_tbl`
--
ALTER TABLE `discipleshipgroup_tbl`
  MODIFY `dgroupID` int(11) NOT NULL AUTO_INCREMENT;
--
...
--
ALTER TABLE `discipleshipgroupmembers_tbl`
  ADD CONSTRAINT `dgmendorsementID` FOREIGN KEY (`dgmendorsementID`) REFERENCES `endorsement_tbl` (`endorsementID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
ALTER TABLE `discipleshipgroup_tbl`
  ...
  ADD CONSTRAINT `dgleader` FOREIGN KEY (`dgleader`) REFERENCES `discipleshipgroupmembers_tbl` (`memberID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
--
ALTER TABLE `endorsement_tbl`
  ADD CONSTRAINT `endorsedMemberID` FOREIGN KEY (`memberID`) REFERENCES `discipleshipgroupmembers_tbl` (`memberID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
