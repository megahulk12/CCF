...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 04, 2017 at 09:32 AM
...
(71, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1'),
...
--
ALTER TABLE `endorsement_tbl`
  MODIFY `endorsementID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=73;
--
...
ALTER TABLE `notifications_tbl`
  ...
  ADD CONSTRAINT `nmemberID` FOREIGN KEY (`memberID`) REFERENCES `member_tbl` (`memberID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
