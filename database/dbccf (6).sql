...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 06, 2017 at 03:05 AM
...
(82, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, '1');
...
(17, 10, 6, 6, 82, NULL, NULL, 'butchersix butchersix is requesting for your approval to be a Dgroup Leader', 2, 0, 1, 1),
(18, 6, 10, NULL, 82, NULL, NULL, 'leader2 leader2 has approved your request to be a Dgroup Leader', 0, 0, 0, 0);
...
--
ALTER TABLE `endorsement_tbl`
  MODIFY `endorsementID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=83;
--
