...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2017 at 03:10 AM
...
CREATE TABLE `budgetdetails_tbl` (
  ...
  `budgetType` int(11) DEFAULT '0',
  `dateEntry` date DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `budgetdetails_tbl`
--

INSERT INTO `budgetdetails_tbl` (`budgetID`, `budget`, `budgetType`, `dateEntry`) VALUES
(64, '123123123', 0, '2017-08-18'),
(83, '5000', 0, '2017-08-18'),
(115, '30000', 0, '2017-08-18'),
(116, '20000', 0, '2017-08-18');
...
(32, 47, 5, 1, 'a', 'a', 'a', NULL, '2017-08-14'),
...
CREATE TABLE `eventdetails_tbl` (
  ...
  `eventStartDay` varchar(30) DEFAULT NULL,
  `eventEndDay` varchar(30) DEFAULT NULL,
  `eventWeekly` varchar(10) DEFAULT NULL,
  `eventStartTime` time DEFAULT NULL,
  `eventEndTime` time DEFAULT NULL,
  `eventVenue` varchar(200) DEFAULT NULL,
  `remarks` mediumtext,
...
--
-- Dumping data for table `eventdetails_tbl`
--

INSERT INTO `eventdetails_tbl` (`eventID`, `budgetID`, `eventHeadID`, `eventPicturePath`, `eventName`, `eventDescription`, `eventStartDay`, `eventEndDay`, `eventWeekly`, `eventStartTime`, `eventEndTime`, `eventVenue`, `remarks`, `eventStatus`, `eventSchedStatus`) VALUES
(49, 64, 42, 'uploads/Elevate Unite Cover.jpg', 'Elevate Unite', 'Elevate Unite', '2017-08-18', NULL, NULL, '16:58:00', '16:58:00', 'Elevate Unite', 'Elevate Unite', 1, 0),
(53, 83, 42, 'uploads/KoolSP.png', 'I WILL NEVER LEAVE YOU NOR FORSAKE YOU', 'I will never leave you nor forsake you\r\n\r\nKool Solo Parents\r\n\r\nAugust 19, Saturday 2:30 â€“ 5:30 pm, Room 5D, CCF Center.\r\n\r\nContact (0927) 911 2178 for more details', '2017-08-19', '2017-08-18', NULL, '14:30:00', '17:30:00', 'CCF Davao', 'An event', 1, 0),
(75, 115, 42, 'uploads/Multiply.png', 'MULTIPLY LEADERâ€™S RETREAT', 'Multiply Leaderâ€™s Retreat\r\n\r\nElevate\r\n\r\nCalling all ELEVATE Main, Taft, Katipunan and U-Belt Dgroup leaders and potential leaders!\r\n\r\nAugust 19-21, Rizal Re-creation Center.\r\n\r\nRetreat cost: P 3,700.\r\n\r\nWe have limited slots available so register now!\r\n\r\n#ElevateMultiply2017', '2017-08-19', '2017-08-21', NULL, '07:00:00', '22:00:00', 'CCF Davao', 'A leader\'s retreat.', 1, 1),
(76, 116, 42, 'uploads/CCF_Digiposters_170813-TL-October.jpg', 'TRUE LIFE', 'True Life\r\n\r\nEncounter 1 Retreat\r\n\r\nOctober 13â€“15, Mt. Makiling Re-creation Center\r\n\r\nRetreat fee: PHP3,500\r\n\r\nContact (0917) 273 5077 for more details', '2017-10-13', '2017-10-27', 'Friday', '16:00:00', '18:00:00', 'CCF Davao', 'True Life Retreat.', 1, 2);
...
CREATE TABLE `eventparticipation_tbl` (
  ...
  `eventPartStatus` int(1) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `eventparticipation_tbl`
--

INSERT INTO `eventparticipation_tbl` (`eventParticipationID`, `eventID`, `memberID`, `eventPartDesc`, `timeParticipation`, `dateParticipation`, `eventPartStatus`) VALUES
(2, 75, 10, NULL, NULL, NULL, 0);
...
(34, 42, 1, NULL, NULL, 49, NULL, 'You have a new event request - Elevate Unite.', 1, 1, 0, 1),
(90, 42, 1, NULL, NULL, 75, NULL, 'You have a new event request - MULTIPLY LEADERâ€™S RETREAT.', 1, 1, 0, 1),
(91, 42, 1, NULL, NULL, 76, NULL, 'You have a new event request - TRUE LIFE.', 2, 1, 0, 1),
(92, 1, 42, NULL, NULL, 76, NULL, 'TRUE LIFE has been approved and is now open for people to view and join.', 1, 1, 0, 0),
(93, 10, 42, NULL, NULL, 75, NULL, 'butchersix butchersix wishes to join MULTIPLY LEADERâ€™S RETREAT', 1, 1, 0, 1),
(94, 42, 10, NULL, NULL, 75, NULL, 'You have received some remarks about your request.<br>Remarks: eventParticipationID', 1, 1, 0, 0);
...
--
ALTER TABLE `budgetdetails_tbl`
  MODIFY `budgetID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=117;
--
...
--
ALTER TABLE `eventparticipation_tbl`
  MODIFY `eventParticipationID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
--
...
ALTER TABLE `eventdetails_tbl`
  ...
  ADD CONSTRAINT `eventHeadID` FOREIGN KEY (`eventHeadID`) REFERENCES `member_tbl` (`memberID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
