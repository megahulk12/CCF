...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 18, 2017 at 05:16 AM
...
INSERT INTO `endorsement_tbl` (`endorsementID`, `dgmemberID`, `pastoralArea`, `remarks`, `baptismalDate`, `baptismalPlace`, `recommendMinistry`, `ageBracket`, `eschedDay`, `eschedStartTime`, `eschedEndTime`, `eschedPlace`, `edgleader`, `edgroupType`, `dateEndorsed`, `endorsementStatus`, `request`) VALUES
(1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0),
(58, 11, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1),
(72, 12, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1),
(76, 17, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0),
(78, 18, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 0),
(84, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0);
...
(5, 'Dodong', 'leader1', 'Laboriki', 'leader1', '2017-06-30', '0', 'Single', 'Filipino', 'Davao', NULL, '09124653245', 'leader1@yahoo.com', 'Student', '2017-06-30', 'leader1', 'leader1', NULL, 1, NULL, 2, 2, '1'),
...
(10, 'butchersix', 'butchersix', 'butchersix', 'butchersix', '1999-02-05', '1', 'Single', 'a', 'a', '', '1', 'a@yahoo.com', 'a', '2017-07-02', 'butchersix', 'butchersix', NULL, 3, NULL, 9, 1, '1'),
...
(19, 'leryc', 'leryc', 'leryc', 'leryc', '2017-07-04', '0', 'Single', NULL, NULL, NULL, '12312312312', NULL, 'Student', '2017-07-04', 'imaginate', 'imaginate', NULL, 12, NULL, NULL, 0, '1'),
(20, 'Samantha', 'Bagares', 'Aclan', 'Sam', '1998-03-10', '1', 'Single', 'Filipino', 'Matina Aplaya, Davao City', '2991846', '09325124522', 'aclan16@gmail.com', 'Freelancer', '2017-07-04', 'wolphy10', '1234', NULL, 12, NULL, NULL, 1, '1'),
(21, '', '', '', '', '1970-01-01', '1', '', NULL, NULL, NULL, '', NULL, '', '2017-07-05', '', '', NULL, NULL, NULL, NULL, 0, '1'),
...
(23, 'Benjamin', 'test', 'Franklin', 'Benj', '2017-07-10', '0', 'Single', 'Filipino', 'mintal', '', '09236642312', 'benjamin@yahoo.com', 'Single', '2017-07-10', 'benj', 'benj', 3, 14, 3, 16, 1, '1'),
...
(23, 10, 6, 6, 84, NULL, NULL, 'butchersix butchersix is requesting for your approval to be a Dgroup Leader', 0, 0, 0, 1);
...
(9, 'aa', 'CCF', 'CCF', '20:24:00', '21:24:00', '17:30:00', '18:45:00', 'Sunday', 'Sunday'),
...
--
ALTER TABLE `discipleshipgroupmembers_tbl`
  MODIFY `dgroupmemberID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
--
...
--
ALTER TABLE `endorsement_tbl`
  MODIFY `endorsementID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85;
--
...
--
ALTER TABLE `preferencedetails_tbl`
  MODIFY `prefID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
...
--
ALTER TABLE `schooldetails_tbl`
  MODIFY `schoolID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
--
-- AUTO_INCREMENT for table `spousedetails_tbl`
--
ALTER TABLE `spousedetails_tbl`
  MODIFY `spouseID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
--
