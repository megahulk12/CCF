...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 05, 2017 at 11:36 AM
...
(58, 11, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1'),
(72, 12, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1'),
(75, 6, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, '1');
...
(6, 'leader2', 'leader2', 'leader2', 'leader2', '2017-06-30', '1', 'Single', 'Fili', NULL, NULL, NULL, NULL, NULL, NULL, 'leader2', 'leader2', NULL, NULL, NULL, NULL, 2, '1'),
...
CREATE TABLE `notifications_tbl` (
  ...
  `memberID` int(11) DEFAULT NULL,
  `requestMemberID` int(11) DEFAULT NULL,
...
INSERT INTO `notifications_tbl` (`notificationID`, `memberID`, `requestMemberID`, `requestdgmemberID`, `endorsementID`, `eventID`, `ministryID`, `notificationDesc`, `notificationStatus`, `notificationType`) VALUES
(2, 10, 6, 6, 75, NULL, NULL, 'butchersix butchersix is requesting for your approval to be a Dgroup Leader', 0, 0);
...
(9, 'a', 'a', 'a', '12:24:00', '12:24:00', '12:24:00', '12:24:00', 'Sunday', 'Sunday'),
...
--
ALTER TABLE `discipleshipgroupmembers_tbl`
  MODIFY `dgroupmemberID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
...
--
ALTER TABLE `endorsement_tbl`
  MODIFY `endorsementID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;
--
...
--
ALTER TABLE `schooldetails_tbl`
  MODIFY `schoolID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;
--
