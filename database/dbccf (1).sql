...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 01, 2017 at 11:06 AM
...
--
-- Table structure for table `dgroupassignment_tbl`
--

CREATE TABLE `dgroupassignment_tbl` (
  `dgoupassignmentID` int(11) NOT NULL,
  `dgadgmemberID` int(11) DEFAULT NULL,
  `dgadgroupID` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `discipleshipgroupmembers_tbl` (
  ...
  `dgmendorsementID` int(11) DEFAULT NULL,
...
INSERT INTO `discipleshipgroupmembers_tbl` (`dgroupmemberID`, `memberID`, `dgroupID`, `dgmendorsementID`, `dgroupmemberStatus`, `receivedChrist`, `attendCCF`, `regularlyAttendsAt`, `remarks`, `dateJoinedAsDgroupMember`) VALUES
(3, 5, 4, NULL, 1, NULL, NULL, NULL, NULL, '2017-06-30');
...
INSERT INTO `discipleshipgroup_tbl` (`dgroupID`, `schedID`, `dgendorsementID`, `dgroupType`) VALUES
(4, 1, NULL, 0);
...
CREATE TABLE `endorsement_tbl` (
  ...
  `endorsementStatus` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `member_tbl` (`memberID`, `firstName`, `middleName`, `lastName`, `nickName`, `birthdate`, `gender`, `civilStatus`, `citizenship`, `homeAddress`, `homePhoneNumber`, `contactNum`, `emailAd`, `occupation`, `dateJoined`, `username`, `password`, `companyID`, `schoolID`, `spouseID`, `preferenceID`, `memberType`) VALUES
(1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'admin', 'admin', NULL, NULL, NULL, NULL, NULL),
(5, 'leader1', 'leader1', 'leader1', 'leader1', '2017-06-30', '0', 'Single', 'Filipino', 'Davao', NULL, '09124653245', 'leader1@yahoo.com', 'Student', '2017-06-30', 'leader1', 'leader1', NULL, 1, NULL, 1, 2),
(6, 'leader2', 'leader2', 'leader2', 'leader2', '2017-06-30', '1', 'Single', 'Fili', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(1, 'Tagalog, Bisaya, English', 'CCF', 'CCF', '13:00:00', '15:00:00', '12:00:00', '16:00:00', 'Saturday', 'Saturday'),
...
CREATE TABLE `spousedetails_tbl` (
  ...
  `spouseBirthdate` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
-- Indexes for table `dgroupassignment_tbl`
--
ALTER TABLE `dgroupassignment_tbl`
  ADD PRIMARY KEY (`dgoupassignmentID`),
  ADD KEY `dgadgmemberID` (`dgadgmemberID`),
  ADD KEY `dgadgroupID` (`dgadgroupID`);
...
ALTER TABLE `discipleshipgroupmembers_tbl`
  ...
  ADD KEY `endorsementID_idx` (`dgmendorsementID`);
...
ALTER TABLE `member_tbl`
  ...
  ADD KEY `preferenceID_idx` (`preferenceID`);
...
--
-- AUTO_INCREMENT for table `dgroupassignment_tbl`
--
ALTER TABLE `dgroupassignment_tbl`
  MODIFY `dgoupassignmentID` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `discipleshipgroupmembers_tbl`
--
ALTER TABLE `discipleshipgroupmembers_tbl`
  MODIFY `dgroupmemberID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
--
-- AUTO_INCREMENT for table `discipleshipgroup_tbl`
--
ALTER TABLE `discipleshipgroup_tbl`
  MODIFY `dgroupID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
-- Constraints for table `dgroupassignment_tbl`
--
ALTER TABLE `dgroupassignment_tbl`
  ADD CONSTRAINT `dgadgmemberID` FOREIGN KEY (`dgadgmemberID`) REFERENCES `discipleshipgroupmembers_tbl` (`dgroupmemberID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `dgadgroupID` FOREIGN KEY (`dgadgroupID`) REFERENCES `discipleshipgroup_tbl` (`dgroupID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `member_tbl`
  ...
  ADD CONSTRAINT `preferenceID` FOREIGN KEY (`preferenceID`) REFERENCES `preferencedetails_tbl` (`prefID`) ON DELETE NO ACTION ON UPDATE NO ACTION,
